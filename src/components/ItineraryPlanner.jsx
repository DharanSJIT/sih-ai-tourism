...
const ItineraryPlanner = () => {
  ...
  return (
    ...
    <div className="min-h-[50vh] bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 sm:p-6 lg:p-8 absolute top-[12vh] w-full max-h-[70vh] ">
      <div className="absolute left-[2vw] top-[-2vh]">
        <Link
          to="/dashboard"
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <p className="text-gray-500 dark:text-gray-400">
                Craft your perfect trip with intelligent suggestions.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={generateItinerary} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-transparent rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-3"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., 7"
                  required
                  className="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-transparent rounded-md p-3"
                />
              </div>
              <div>
                <label htmlFor="budget" className="block text-sm font-medium">
                  Budget (Rs. per person)
                </label>
                <input
                  type="number"
                  id="budget"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-300"
            >
              {loading ? (
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg relative min-h-[500px]">
          <div className="sticky top-8">
            {" "}
            {/* Adjusted sticky top to account for navbar */}
            ...
            {!loading && !itinerary && (
              <div className="flex flex-col items-center justify-center h-full mt-20 text-center">
                ...
                <p className="mt-4 text-lg text-gray-500 dark:text-gray-400">
                  Your trip plan will appear here once generated.
                </p>
              </div>
            )}
            {itinerary && (
